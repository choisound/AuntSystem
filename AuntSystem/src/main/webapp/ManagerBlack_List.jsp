    ...
    <div class="content" id="content">
        <table id="table1">
            ...
            <tr v-for="(item,index) in items" :class=((index%2==0)?"alt":"")>
                <td>{{item.systemBlacklistId}}</td>
                <td><span class="openWin" v-on:click="detail(item.auntInfo.auntPhoneno)">{{item.auntInfo.auntPhoneno}}</span></td>
                <td><span class="delete" v-on:click="Delete(item.systemBlacklistId,index)">Delete</span></td>
            </tr>
            <!--<tr>-->
                <!--<td>Black_id</td>-->
                <!--<td>Aunt_id</td>-->
...
<script src="Javascript/Js/ManagerBlack_List.js"></script>