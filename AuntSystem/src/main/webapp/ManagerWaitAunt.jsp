...
<body>
    ...
    <div class="content" id="content">
        <table id="table1">
            ...
            <tr  v-for="(item,index) in items" :class=((index%2==0)?"alt":"")>
                ...
                <td><span href="" class="delete" v-on:click="Delete(item.auntId,index)">Delete</span></td>
            </tr>
            <!--<tr>-->
    ...
    <div id="division"></div>
    <div class="footer">版权所有：上天入地OneBoom团队</div>
</body>
</html>
<script src="Javascript/require.js"></script>
<script src="Javascript/Js/ManagerWaitAunt.js"></script>